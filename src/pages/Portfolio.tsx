    ...
    <div className="bg-background min-h-screen text-foreground pt-24 md:pt-32 pb-20">
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12">
        <header className="mb-16 md:mb-24 text-center md:text-left">
          ...
          <h1 className="text-4xl md:text-8xl font-heading font-black tracking-tighter uppercase mb-6 drop-shadow-lg leading-tight">
            Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0096FF] via-[#FF1A1A] to-[#FFD60A]">Portfolio</span>
          </h1>
          <p className="text-lg md:text-2xl font-light text-foreground/70 max-w-3xl">
             ...
             >
                ...
                <div className="absolute inset-0 p-6 md:p-12 flex flex-col justify-between z-10 pointer-events-none">
                  <div className="flex justify-between items-start">
                    <span className="font-mono text-[10px] md:text-xs px-3 py-1.5 md:px-4 md:py-2 border border-foreground/20 rounded-full tracking-widest backdrop-blur-md bg-background/50 uppercase">
                      0{i + 1} / {business.name.split(' ')[1] || 'Venture'}
                    </span>
                    <div 
                      className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center border border-foreground/20 backdrop-blur-md transition-transform duration-500 group-hover:bg-foreground group-hover:text-background"
                    >
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="opacity-50 group-hover:opacity-100 md:w-5 md:h-5">
