  ...
  return (
    <div className="bg-background text-foreground min-h-screen font-sans selection:bg-[#FF1A1A]/40">
      <section ref={ref} className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto flex flex-col items-center">
          ...
          <motion.p 
            ...
            className="uppercase tracking-[0.4em] text-xs font-semibold mb-6 text-[#FF1A1A]"
          >
            A 508 Venture
          </motion.p>
          <motion.h1 
            ...
            className="text-6xl md:text-8xl lg:text-[140px] font-heading font-medium tracking-tighter leading-none mb-8"
          >
          ...
          <motion.p 
            ...
            className="text-xl font-light text-foreground/50 tracking-widest max-w-2xl mx-auto uppercase"
          >
      ...
      <section className="py-32 px-6 md:px-12 max-w-[1200px] mx-auto text-center">
        <h2 className="text-3xl md:text-5xl font-heading tracking-tight leading-relaxed font-light italic text-foreground/80">
      ...
      <section className="py-20 px-6 md:px-12 max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
         {[
           ...
           <div key={i} className="group relative h-[600px] overflow-hidden rounded-sm">
             ...
             <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
               <h3 className="text-3xl font-heading text-foreground mix-blend-overlay opacity-80 group-hover:opacity-100 transition-opacity drop-shadow-2xl">{item.title}</h3>
             </div>
           </div>
         ))}
      </section>

      <section className="py-32 px-6 text-center border-t border-foreground/5 mt-20">
        <Link 
          to="/#contact"
          className="inline-block px-12 py-6 rounded-none text-foreground border border-foreground/20 hover:border-[#FF1A1A] hover:bg-[#FF1A1A]/10 font-semibold uppercase tracking-[0.2em] text-xs transition-all duration-500"
        >
