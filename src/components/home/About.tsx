  ...
  return (
    <section ref={containerRef} className="relative py-40 overflow-hidden bg-background">
      <div className="absolute inset-0 z-0 opacity-30">
        ...
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-accent/10 rounded-full blur-[100px]"></div>
      </div>
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 relative z-10">
        <motion.div 
          ...
          className="max-w-5xl"
        >
          <h2 className="text-4xl md:text-6xl lg:text-8xl font-heading font-medium tracking-tighter leading-[1.1] text-foreground">
        ...
        <div className="mt-40 relative">
          ...
          <div className="py-20 overflow-hidden">
            <motion.div style={{ x: x1 }} className="flex gap-8 whitespace-nowrap opacity-20">
              <span className="text-[150px] font-heading font-bold uppercase tracking-tighter text-transparent" style={{ WebkitTextStroke: '1px white' }}>
                Retail • Media • Agriculture • Lifestyle • Commerce •
              </span>
            </motion.div>
            <motion.div style={{ x: x2 }} className="flex gap-8 whitespace-nowrap opacity-20 -mt-16">
              <span className="text-[150px] font-heading font-bold uppercase tracking-tighter text-transparent" style={{ WebkitTextStroke: '1px white' }}>
